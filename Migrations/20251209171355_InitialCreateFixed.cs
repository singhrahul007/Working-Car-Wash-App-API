        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "all"),
                    ApplicableServices = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, defaultValue: "[\"all\"]"),
                    Icon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "gift"),
                    ColorCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "#2196F3"),
                    Terms = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    UsageLimit = table.Column<int>(type: "int", nullable: false, defaultValue: 1000),
                    UsedCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    IsOneTimePerUser = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxBookingsPerSlot = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "DATEADD(minute, 10, GETUTCDATE())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "car"),
                    ACType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ACBrand = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SofaType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SofaCount = table.Column<int>(type: "int", nullable: true),
                    ...
                    AppliedOfferCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OTPs_Email_Type_CreatedAt",
                table: "OTPs",
                columns: new[] { "Email", "Type", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OTPs_MobileNumber_Type_CreatedAt",
                table: "OTPs",
                columns: new[] { "MobileNumber", "Type", "CreatedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceReviews_UserId_ServiceId",
                table: "ServiceReviews",
                columns: new[] { "UserId", "ServiceId" });

            migrationBuilder.CreateIndex(
                name: "IX_SocialAuths_Provider_ProviderId",
                table: "SocialAuths",
                columns: new[] { "Provider", "ProviderId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SocialAuths_UserId_Provider",
                table: "SocialAuths",
